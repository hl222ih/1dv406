        ...
        <div id="content">
            ...
            <div>
                ...
                <div class="errorMessage">
                    <asp:RegularExpressionValidator ID="revAmount" runat="server" ErrorMessage="Felaktigt format." ControlToValidate="txtAmount" ValidationExpression="(?(?=^\s*0*(?:,0+)?\s*$)|^\s*\d+(?:,\d+)?\s*$)" CssClass="revAmount"></asp:RegularExpressionValidator>
            ...
            <asp:Panel ID="pnlReciept" runat="server" Visible="False">
                <div class="reciept">
                    <div class="logo">
                        <p>DeVe</p>
                    </div>
